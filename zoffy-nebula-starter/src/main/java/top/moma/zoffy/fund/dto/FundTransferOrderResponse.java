...
@Data
public class FundTransferOrderResponse implements Serializable {

    private static final long serialVersionUID = -5039946808756994902L;
    /**
     * 调拨单id;唯一主键id
     */
    ...
    /**
     * 审核状态;业务枚举，默认1，0:待审批;1:审批中;2:审批通过;3:审批拒绝;
     */
